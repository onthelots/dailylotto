                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () {
                            context.read<DailyQuestionBloc>()
                              ..add(LoadDailyQuestionEvent());
                          },
                          child: Text(
                            "새고로침",
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children:
                              _dailyQuestionContainer!.options.map((option) {
                            return Padding(
                              padding: const EdgeInsets.symmetric(
                                  vertical: boxPadding, horizontal: boxPadding),
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isSelected
              ...
              : Theme.of(context).cardColor, // 배경색
          border: Border.all(
